...
<title>Kirana Pasal | Testomonials</title>
<!--Bootstrap -->
...
{ ?>
              ...
              <li>
                ...
                <?php if($result->status==1){ ?>
                 <div class="products_status"> <a class="btn outline btn-xs active-btn">Active</a>

                  <div class="clearfix"></div>
                  </div>
                  <?php } else {?>
               <div class="products_status"> <a href="#" class="btn outline btn-xs">Waiting for approval</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
