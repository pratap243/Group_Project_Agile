...
<head>
	...
	<title>Online Kirana Pasal |Admin Manage Testimonials   </title>
						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT tblbooking.userEmail, tblproduct.ProductName,tblbooking.quantity,  tblbooking.deliverydate, tblbooking.message FROM tblbooking, tblproduct WHERE tblbooking.pid = tblproduct.id";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>
										<tr>
											...
											<td><?php echo htmlentities($result->deliverydate);?></td>
