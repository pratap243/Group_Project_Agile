...
<head>
	...
	<title>Online Kirana Pasal | Admin Edit product Info</title>
...
<div class="form-group">
<div class="col-sm-4">
Image 1 <img src="img/productimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
