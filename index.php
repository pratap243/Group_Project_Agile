      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>New Clothes are Available</h1>
            <p>Cheap price & branded clothes</p>
            <a href="page.php?type=aboutus" class="btn">Read More onine shop <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Buy new brand clothes online at best prices in  <span> Kathmandu, Nepal.</span></h2>
      <p>To buy nline clothes and new branded cllothes in low cost. t-shirt, piant, shirt, cap etc.</p>
    </div>
    <div class="row">
