		...
		<!-- Two -->
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					...
					-->	</section>
						<p><b> Why BookBusTicket for Bus Booking? </b>
...
<a name="contact"></a>
		<!-- Footer -->
			...
			<!--				<ul class="icons">
					...
					<ul class="copyright">
						<li>&copy; 2019 BookBusTicket. All rights reserved. Brought To You By <a href="#/">Tuphan </a></li>
				</ul>
				</div>
			</footer>
